...
private JButton Add_btn, Sub_btn, Mul_btn, Div_btn, equalBtn,
decBtn;
...
functionBtn[i].setFont(new Font("Orbitron", Font.PLAIN,
...
NumberBtn[i].setFont(new Font("Orbitron", Font.PLAIN,
